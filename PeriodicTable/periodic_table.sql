...
--
-- Name: elements uniqname; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements uniqsymb; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uniqsymb UNIQUE (symbol);


--
-- Name: properties fkey2; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkey2 FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
